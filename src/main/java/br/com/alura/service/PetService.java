...
public class PetService {
    ...
    public PetService(ClientHttpConfiguration config) {
    ...
    public void listarPetsDoAbrigo() throws IOException, InterruptedException {
        ...
        HttpResponse<String> response = this.clientHttpConfiguration.dispararRequisicaoGet("http://localhost:8080/abrigos/" + idOuNome + "/pets");
