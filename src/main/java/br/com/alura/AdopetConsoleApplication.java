...
public class AdopetConsoleApplication {
    ...
    private static HttpResponse<String> disparaRequisicaoPost(String uri, JsonObject json) throws IOException, InterruptedException {
        HttpClient client = HttpClient.newHttpClient();
    ...
    private static void cadastrarAbrigo() throws IOException, InterruptedException {
        ...
        HttpResponse<String> response = disparaRequisicaoPost("http://localhost:8080/abrigos", json);
        int statusCode = response.statusCode();
        String responseBody = response.body();
        if (statusCode == 200) {
